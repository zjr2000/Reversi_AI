...
class AI(object):
    ...
    def evaluate(size, board):
        ...
        if state > 60:
            ...
            value = 10*number + 20110*corner - 4777*xLocation + 89*mobility + 70*stable + 74*outside + map_val
        elif 20 < state <= 40:
            value = 10*number + 20120*corner - 4777*xLocation + 135*mobility + 76*stable + 74*outside + 10*inside + map_val
        else:
            value = 10*number + 20100*corner - 4777*xLocation + 94*mobility + 74*stable + 76*outside + 10*inside + map_val
