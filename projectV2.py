...
class AI(object):
    ...
    def evaluate(size, board):
        ...
        if state > 60:
            ...
            value = 10*number + 20060*corner - 4777*xLocation + 91*mobility + 70*stable + 74*outside + map_val
        elif 20 < state <= 40:
            value = 10*number + 20080*corner - 4777*xLocation + 137.5*mobility + 78*stable + 75*outside + 6*inside + map_val
        else:
            value = 10*number + 20040*corner - 4777*xLocation + 107*mobility + 78*stable + 74*outside + map_val
